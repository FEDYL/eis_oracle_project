...
<<<<<<< HEAD:src/libdb/oracle/oracleconnection.cpp
	std::cout << "terminateConnection(OracleConnection * connection);\n";
=======
>>>>>>> 5b7fe30298b5b7766e0a97101fdfcee844df2e3e:src/libdb/oracle/oracleconnection.cpp
